        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">到龄退出预警</h3>
                </div>
            </div>
            <!-- ============================================================== -->
...
//                return row.examine == null ? "" : row.examine.comping == 1 ? "是" : "否";
        ...
        var w = {
            ...
            width: 240,
            formatter: function (value, row, index) {
                return "<a class='btn btn-info' style='color: #fff' onclick='SH(" + row.id + ")'><span class='fa fa-edit'></span> 退出审核</a>";
            }
        };
        columns.push(a);
        columns.push(b);
