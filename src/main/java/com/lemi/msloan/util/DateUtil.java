...
public final class DateUtil {
    ...
    /*     */ {
        ...
        calendar.add(5, day.intValue());
        /* 147 */
        SimpleDateFormat df = new SimpleDateFormat(dataPattern);
        /* 148 */
        String dateString = df.format(calendar.getTime());
        /* 149 */
        return dateString;
    ...
    /*     */ {
        ...
        try {
            /* 212 */
            lastDay = Integer.valueOf(Integer.parseInt(formatDate(lastDate, "yyyy-MM-dd HH:mm:ss").substring(8, 10)));
            /*     */
        } catch (Exception e) {
            /* 214 */
            e.printStackTrace();
...
//		calendar.add(Calendar.MONTH, -1);
    ...
    public static List<String> getHalfLastMonth() {
    ...
    public static int monthDistance(Long smdate, Long bdate) {

        Date str1 = new Date(smdate);
        Date str2 = new Date(bdate);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        System.out.println("str=" + sdf.format(str1));
        System.out.println("str2=" + sdf.format(str2));
        Calendar bef = Calendar.getInstance();
        Calendar aft = Calendar.getInstance();
        bef.setTime(str1);
        aft.setTime(str2);
    ...
    public static void main(String[] args) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        try {
//            List<String> result = getMonthListBetween("2019-05-01","2019-06-01");
...
////             }
            ...
            //1580486400000
            //1588262400000
            //System.out.println(monthDistance(1580486400000l, 1588262400000l));
